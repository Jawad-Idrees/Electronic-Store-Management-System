...
public class TV_section extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TV_section frame = new TV_section();
...
//		catch(Exception exc){}
		...
		String[] columns= {"Name", "Price", "Quantity","Rating","Code","Screen"};
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(delete_field.getText().trim().isEmpty())
				...
				if(i==ac.size()) {
					...
					try {outing = new ObjectOutputStream(new FileOutputStream("TV.bin"));
